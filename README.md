...
#### Пользователя;
    Пользователю важно хорошое сочитание ui + ux. То есть чтобы на сайте были удобные кнопки достаточного размера,
    хорошо читаемый шрифт, понятная навигация, а так же приятная цветовая схема блоков. Так же важна скорость 
    рендера элементов сайта(если сайт работает с большим потоком серверных данных, то  крайне желательно добавить
    скелеторы на сайт для юллизии более быстрой загрузки) и минимальная перерисовка  DOM дерева(в случае частых 
    перерисовок пользователь будет видеть неприятные моргания). Так же одним из основных отличий является её 
    отзывчивость, понятное глазу отображражение на разных устройствах, браузерах и ширинах экрана.
####менеджера проекта;
    ...
    реализовать.
####дизайнера;
    Дизайнеру важно соотвествие верстки и макета.
####верстальщика;
    Верстальщику важна расширяемость верстки и понятные в соотвествии с договоренностями имена css классов.
...
###Расскажите о своем опыте верстки подобных сайтов: какие методологии, инструменты и технологии вы применяли на практике. 
    ...
    повторящийхся свойств css. По итогу верстка проекта получается очень гибкая и легко изменяемая/расшерияемая.
    
    Из методологий, инструментов и технологий давайте опишу, то что ближе к верстве сначало по моему мнению.
    Это БЭМ, SCSS, flexbox, webpack, React, classnames - библеотеку для упрощения работы с css классами,
...
###Q3 Опишите основные особенности верстки сайтов, которые должны одинаково хорошо отображаться как на любом современном компьютере, так и на смартфонах и планшетах под управлением iOS и Android. Расскажите о своем опыте верстки подобных сайтов: какие инструменты и технологии вы применяли, как проверяли результат на различных устройствах, какие именно устройства требовалось поддерживать. 
    Важно добавить нужные метатэги, после обнулить стили, для этого я использую библеотеку normalize.css,
    ...
    оказалось, благодаря https://caniuse.com/ псевдоэлемент ::before не поддерживается в IE 11, но благодаря прописаному
    свойству
    ...
    внести соотвествующие правки в конфиг вебпака.
...
###Q8 Расскажите нам о себе и предоставьте несколько ссылок на последние работы, выполненные вами. 
    ...
    что ей занимаются низкоквалифированные специалисты, поэтому я её избегал, не учил. Но относительно недавно у меня 
    ...
    кабинета, дали лист А4 с информацией и сказали сделай, но в силу специфичных правок, а так же символического бюджета
